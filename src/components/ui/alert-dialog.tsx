...
>(({ className, onOpenAutoFocus, onCloseAutoFocus, ...props }, ref) => (
  <AlertDialogPortal>
    ...
    <AlertDialogPrimitive.Content
      ref={ref}
      onOpenAutoFocus={(e) => {
        // Defensive reset for Radix layering edge-cases (e.g. dialog opened from context actions).
        document.body.style.pointerEvents = "";
        onOpenAutoFocus?.(e);
      }}
      onCloseAutoFocus={(e) => {
        // Keep body interactive if DismissableLayer leaves pointer-events stuck at "none".
        document.body.style.pointerEvents = "";
        onCloseAutoFocus?.(e);
      }}
      className={cn(
