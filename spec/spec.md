...
R-053 — Множественные инстансы устройств в профиле:
   ...
   - Runtime-конфигурация SHOULD выбирать рабочий инстанс для каждого поддерживаемого источника (`zima2r`, `gnss-udp`) автоматически (fallback на первый доступный инстанс типа).
