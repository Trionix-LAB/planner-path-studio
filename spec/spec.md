...
���������� � ����������� R-013, R-014, R-016, R-020, R-026, R-036, R-037:

- Draft -> Mission conversion MUST ���������� ����������� ���������� draft/current � ������� ����� ������ (�������, �����, UI-���������), � �� ��������� ������ ������ ������ ���������.
- ����� �������� ��������� draft � mission ���� draft/current MUST ���������; �������������� ��������� ����� ��������� �� ������ ������������ ��� ����������.
- ���� ��� �������� draft ��������� transient ������ ���� Mission file not found (TOCTOU/�����), ���������� SHOULD ������������� ����������� ������ draft ������ ����������� ������.
- ��� ������ ������ � �������� Create/Open ������ source of truth ��� ���������� ������ MUST ���� planner.missionsDir � settings; ��������� ���������� � ����� �� �������/�������� ������ ���������� ������������.
- �������������� MUST ����� ���������� durability-������:
  - ������� staging � WAL (������� ����: �� ~0-1 �������),
  - checkpoint � �������� ����� ������ (���������� ������).
- ��� �������� ����������/���� MUST ����������� best-effort ����������� �������� ������:
  - ����������/������ ��������� ���������,
  - ������� ����� mission.lock,
  - ��������� prepare-close flow ��� Electron � timeout fallback.
- �������� ������ MUST ������������ recovery �� ��������� ����������:
  - fallback � mission.json �� mission.json.bak,
  - ��� ������� ����� ������� WAL-������ ����� ����� ������ ��������� �� mission.updated_at � self-heal checkpoint.
- ��� stale mission.lock MUST ������������ recover-path (����������������� �������������� ��������), ����� lock �� �������� � ������������ ������������� ������ ����� ������������� ����������.
