...
Критерии готовности:
- CSV и метаданные треков соответствуют [spec/spec.md](../spec/spec.md).
...
13. [x] Outdated lanes + перегенерация после изменения зоны  
Приоритет: `P1`  
Оценка: `5 SP`  
Описание:
...
14. [x] Каскадное удаление зоны и галсов  
Приоритет: `P1`  
Оценка: `3 SP`  
Описание:
...
15. [x] Настройки: persistence + runtime apply  
Приоритет: `P1`  
Оценка: `8 SP`  
Описание:
...
16. [x] Экспорт GPX/KML/CSV (реальный)  
Приоритет: `P1`  
Оценка: `8 SP`  
Описание:
...
18. [x] Измерения маршрута (сегменты + total) без моков
Приоритет: `P2`  
Оценка: `3 SP`  
Описание:
...
19. [x] Улучшение отображения статуса связи
Приоритет: `P2`  
Оценка: `2 SP`  
Описание:
