...
См. также:
- `docs/mission-format.md` - формат хранения миссий (папка миссии, `mission.json`, CSV/GeoJSON).
- `docs/screens.md` - основные экраны и навигация MVP.
...
21. Формат хранения трека в миссии: CSV.
   - Детальное описание формата CSV, имен файлов и заголовков см. в [docs/mission-format.md](mission-format.md).
   - Основные принципы:
...
29. Структура и форматы файлов миссии детально описаны в [docs/mission-format.md](mission-format.md).
...
31. Внутренние форматы (кратко):
   ...
   - треки: CSV.
   - См. [docs/mission-format.md](mission-format.md) для полных схем.
32. Автосохранение:
...
41. Хранение настроек:
   ...
   - Переопределения для миссии — в `mission.json` (см. [docs/mission-format.md](mission-format.md)).
